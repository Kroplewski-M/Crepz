...
export const ProductCard = (Props:ProductsProps)=>{
    ...
    return(
        <div className="md:w-[250px] md:h-[425px] w-[165px] pb-5 md:pb-5 bg-[#333333] rounded-md relative overflow-hidden hover:cursor-pointer hover:bg-[#444444]">
            <div className={`md:w-[200px] md:h-[200px] w-[150px] h-[150px] rounded-full absolute -right-10 ${getGenderColor()}`}></div>
            <img src={getImg(Props.info.ImgUrl)} alt={Props.info.Name} className={`md:w-[200px] w-[130px] rounded-t-md relative z-10 -rotate-[20deg] md:ml-[60px] ml-5 ${imgLoaded?(''):('hidden')}`} onLoad={()=>setImgLoaded(true)} />
            ...
            <p className={`font-bold text-gray-200 ${Props.info.Name.length > 35?('text-[13px]'):('text-[12px] lg:text-[18px]')}  h-[40px] text-center md:mt-0  z-50 relative w-[90%] mx-auto`}>{Props.info.Name}</p>
            <div className='pl-5 md:mt-5 mt-[5px] text-[15px] md:text-[16px]'>
                <p className='text-gray-400 pt-[5px] lg:pt-0'>{Props.info.Gender} Shoes</p>
