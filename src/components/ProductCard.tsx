...
export const ProductCard = (Props:ProductsProps)=>{
    ...
    return(
        <div className="md:w-[300px] md:h-[400px] w-[200px] pb-5 md:pb-0 bg-[#333333] rounded-md relative overflow-hidden hover:cursor-pointer hover:bg-[#444444]">
            ...
            <p className='font-bold text-gray-200 text-[20px] text-center md:mt-0 z-50 relative'>{Props.info.Name}</p>
